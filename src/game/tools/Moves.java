...
public class Moves {
	...
	// kontrollera inmatning (felhantera) och lÃ¤gg till logiken att anvÃ¤ndaren ska inte vÃ¤lja en ruta som inte existerar
	...
	public String[][] computerMove(String[][] CompBoard) {
		...
		int randomRow = rand.nextInt(3); // slumpa ett vÃ¤rde
