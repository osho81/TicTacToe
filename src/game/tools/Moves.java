...
public class Moves {
	...
	private void user(String[][] board, Scanner sc) {
		...
		/* while loopen kollar att inmatat värdet skapa ingen konflikt med valda drag (datorns/användarens) */
		while (!valid) {
			int x = -1, y = -1, found = 0;
	...
	/* metoden tvingar användaren att mata en siffra
	   mellan 1 och 9 och inte någon annan char - sedan returnerar den en giltig siffra */
